...
prediction_mean, prediction_var = rbf_regression_over_large_array(*images[:-split], lengthscales=12, it_step=MEMORY_STEP_3D, include_zeros=True, method="fast", do_optimization=False)
